...
import Utils.State.MyProcedureTable;
...
public class Interpreter {
    public static void main(String[] args) {
        ...
        try {
            ...
            PrgState prg1 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p1);
        ...
        try {
            ...
            PrgState prg2 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p2);
        ...
        try {
            ...
            PrgState prg3 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p3);
...
//        Ref int v;new(v,20);Ref Ref int a; new(a,v);print(v);print(a)
            ...
            PrgState prg4 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p4);
        ...
        try {
            ...
            PrgState prg5 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p5);
        ...
        try {
            ...
            PrgState prg6 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p6);
        ...
        try {
            ...
            PrgState prg7 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p7);
        ...
        try {
            ...
            PrgState prg8 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p8);
        ...
        try {
            ...
            PrgState prg9 = new PrgState(new MyStack(), new MyDic<>(), new MyDic<>(), new MyHeap<>(), new MyLockTable(), new MyProcedureTable(), new MyList<>(), p9);
