...
//        int a; int b; a=5; b=7; if a>b then print(a) else print(b)
        ...
        IStmt p11 = new CompStmt(
                new VariableDeclStmt("v", new Int()),
                new CompStmt(
                        new WhileStmt(
                                new RelationalExp("<", new VariableExpr("v"), new ValueExp(new IntValue(3))),
                                new CompStmt(
                                        new ForkStmt(
                                                new CompStmt(
                                                        new PrintStmt(new VariableExpr("v")),
                                                        new AssignStmt("v", new ArithExp('+', new VariableExpr("v"), new ValueExp(new IntValue(1))))
                                                )
                                        ),
                                        new AssignStmt("v", new ArithExp('+', new VariableExpr("v"), new ValueExp(new IntValue(1))))
                                )
                        ...
                        new CompStmt(
                                new SleepStmt(5),
                                new PrintStmt(new ArithExp('*', new VariableExpr("v"), new ValueExp(new IntValue(10))))
                        )
                )
