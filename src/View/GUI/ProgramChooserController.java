...
//        int a; int b; a=5; b=7; if a>b then print(a) else print(b)
        ...
        IStmt p11 = new CompStmt(
                        new VariableDeclStmt("a", new Int()),
                        new CompStmt(
                                new VariableDeclStmt("b", new Int()),
                                new CompStmt(
                                        new VariableDeclStmt("c", new Int()),
                                        new CompStmt(
                                                ...
                                                new CompStmt(
                                                        ...
                                                        new CompStmt(
                                                                ...
                                                                new CompStmt(
                                                                        new SwitchStmt(
                                                                                new ArithExp('*', new VariableExpr("a"), new ValueExp(new IntValue(10))),
                                                                                new ArithExp('*', new VariableExpr("b"), new VariableExpr("c")),
